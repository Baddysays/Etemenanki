...
public slots:
    ...
    Q_INVOKABLE QString saveFileFilter() const;
...
private:
    ...
    QString uiTr(const QString& key) const;

    QString uiTrArgs(const QString& key, const QStringList& args = {}) const;

    QString localizeStatusMessage(const QString& message) const;
    ...
    void cleanupExternalPdfTranslateJob();
    ...
    QThread* m_externalPdfThread = nullptr;

    ExternalPdfTranslateWorker* m_externalPdfWorker = nullptr;
