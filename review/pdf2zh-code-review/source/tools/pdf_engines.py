...
def translate_pdfmathtranslate(
    ...
    proc = subprocess.run(
        ...
        env=env,
        cwd=str(run_cwd),
        timeout=max(600, int(os.environ.get("ETE_PDF2ZH_TIMEOUT", "3600"))),
        check=False,
    )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    translate.add_argument("--cloud-key", default="")
